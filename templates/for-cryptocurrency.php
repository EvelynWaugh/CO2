            ...
            <div class="row lp_one_screen_row">
                <div class="lp_one_screen_form">
                    <div class="buy_from">
                        ...
                        <form class="cart quantity_method" action="<?php echo esc_url(get_permalink(127)); ?>" method="post" enctype='multipart/form-data'>
                            <?php wp_nonce_field('co2_quiz_action', 'co2_quiz_name') ?>
                            ...
                            <button type="submit" name="co2-add-to-cart" value="<?php echo esc_attr($product->get_id()); ?>" class="single_add_to_cart_button button alt buy_from_btn"><?php _e('Offset now', 'co2') ?></button>
            ...
            <div class="lp_one_screen_slider">
                ...
                <div class="lp_one_screen_slides">
                    <div class="lp_one_screen_slide">
                        <div class="lp_one_screen_slide_icon"><img src="<?php echo CO2_URL . '/img/lp_one_slide_icon.svg'; ?>" alt=""></div>
                    ...
                    <div class="lp_about_us_left">
                        <div class="about_us_logo_block">
                            <div class="about_us_logo_block_img">
                                <img src="<?php echo CO2_URL . '/img/about_us_logo.svg'; ?>" alt="">
                            </div>
                            ...
                            <a href="<?php echo $product->get_permalink(); ?>">
                                <div class="lp_slide">
                                    <div class="lp_slide_top">
                                        <img src="<?php echo CO2_URL . '/img/lp_slider_cloud.svg'; ?>" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="buy_from">
                    ...
                    <?php
                    $product = wc_get_product(130);
                    ?>
                    <?php do_action('co2_before_add_to_cart_form'); ?>

                    <form class="cart price_method" action="<?php echo esc_url(get_permalink(127)); ?>" method="post" enctype='multipart/form-data'>
                        <?php wp_nonce_field('co2_quiz_action', 'co2_quiz_name') ?>
                        <?php do_action('co2_before_add_to_cart_button'); ?>
