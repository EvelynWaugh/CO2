    ...
    <section class="type_page apis_page">
        <div class="container">
            ...
            <div class="row type_page_row_next">
                <div class="type_page_left">
                    <div class="type_page_left_subtitle"><?php echo get_field('consult_api'); ?> <a href="maito:<?php echo get_theme_mod('email_co2', ''); ?>" target="blank"><?php echo get_theme_mod('email_co2', ''); ?></a></div>
                </div>
                <div class="type_page_right">
